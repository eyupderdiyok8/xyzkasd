...
const mockAuth = {
  ok: true, userId: 'user-1', role: 'viewer' as const, tenantId: 'tenant-1', error: null, membershipType: 'MONTHLY', expiresAt: new Date(Date.now() + 365 * 86400000).toISOString(), isActive: true,
};

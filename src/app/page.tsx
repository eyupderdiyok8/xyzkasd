      ...
      <nav className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 border-b ${scrolled ? 'border-white/5 bg-gray-950/80 backdrop-blur-xl' : 'border-transparent'}`}>
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Link href="/register" className="rounded-xl bg-gradient-to-r from-blue-500 to-cyan-500 px-3 sm:px-5 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold text-white shadow-lg shadow-blue-500/25 transition-all hover:shadow-xl hover:shadow-blue-500/40">
              Şimdi Başlayın
            </Link>
          </div>
        </div>
